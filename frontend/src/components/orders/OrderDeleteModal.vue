<template>
    <div>
        ...
        <transition name="modal-backdrop">
            <div v-if="isOpen"
                class="fixed inset-0 flex items-center justify-center z-[80] font-montserrat p-4 md:pt-20">
                ...
                <transition name="modal">
                    <div v-if="isOpen"
                        ...
                        <h3 class="text-base md:text-lg font-bold mb-4">Tem certeza que deseja excluir o pedido #{{
                            itemName }}?</h3>
