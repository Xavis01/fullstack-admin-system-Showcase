        ...
        <transition name="modal">
          <div v-if="isOpen"
            ...
            <div class="bg-red-600 text-white p-3 md:p-4 text-center flex items-center justify-center gap-2 md:gap-3">
              ...
              <h3 class="text-lg md:text-xl font-bold">FILTRAR CLIENTES</h3>
            </div>
            <!-- Body section omitted -->
            <div class="p-4 sm:p-5 md:p-6">
              <div class="mb-4">
                <label class="block text-gray-700 text-xs md:text-sm font-bold mb-2">Nome do Cliente</label>
...
const sortOptions = [
  ...
  { value: 'total', label: 'Total de Compras' }
]
